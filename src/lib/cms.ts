...
export const DEFAULT_CMS: CMSData = {
  ...
  store: {
    ...
    phone: import.meta.env.VITE_STORE_PHONE || "+91 9633419902",
    whatsapp: import.meta.env.VITE_STORE_WHATSAPP || "919633419902",
    email: import.meta.env.VITE_STORE_CONTACT_EMAIL || "rassaboutique@gmail.com",
    address: import.meta.env.VITE_STORE_ADDRESS || "Near NIT Calicut Campus, Kattangal-Koduvally Road, Kattangal, Kozhikode, Kerala 673601",
    city: "Kattangal, Kozhikode",
    state: "Kerala",
    pincode: "673601",
    gst: "",
    hours: "Mon–Sat: 11am–11pm | Sun: 11am–8pm",
    instagram: import.meta.env.VITE_INSTAGRAM_URL || "https://instagram.com/rassa_boutique",
    facebook: "",
    youtube: "",
    googleMapsLink: "https://maps.google.com/maps?q=Rassa+Boutique+Kattangal+Kozhikode+Kerala+673601&output=embed",
    logoUrl: "",
